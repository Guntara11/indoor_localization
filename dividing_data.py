...
if __name__ == "__main__":
    ...
    print(folder_path)
    if ("modified" in folder_path and "filtered" not in folder_path):
            ...
            for file_name in file_list:
                if file_name.endswith('.csv'):
                    ...
                    for i, (train_data, test_data) in enumerate(partitioned_data, 1):
                        ...
                        train_data.to_csv(f'filtered_calibrated_dataset/train_{file_name}_partition_{i}.csv', index=False)
                        test_data.to_csv(f'filtered_calibrated_dataset/test_{file_name}_partition_{i}.csv', index=False)
                    print("Train Data (First Partition):")
                    print(partitioned_data[0][0])
        ...
        dataset_calibration_path = "filtered_calibrated_dataset"
